...
class CreateOswfHistorystepTable extends Migration
{
    final public function up(): void
    {
        Schema::create('oswf_historystep', function (Blueprint $table) {
            $table->addColumn('bigInteger', 'id', ['unsigned' => true]);
    ...
    {
        Schema::dropIfExists('oswf_historystep');
    }
}
