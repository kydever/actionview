...
class CreateUserIssueListColumnsTable extends Migration
{
    final public function up(): void
    {
        Schema::create('user_issue_list_columns', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('user_issue_list_columns');
    }
}
